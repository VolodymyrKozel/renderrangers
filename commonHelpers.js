import{r as a,a as k}from"./assets/renderMarkup-9fdcb560.js";import{a as w,S as L,N as v}from"./assets/vendor-dcaf4cbb.js";const x="https://books-backend.p.goit.global/books/";async function g(e,t){try{return(await w.get(x+e,{params:t})).data}catch(o){console.error(o)}}console.log("category-card");const S=async e=>{a.categoryCardElem.innerHTML="",a.topSellerSection.innerHTML="";try{const t=await g("category",e),o=a.categoryCardElem.querySelector(".category-card-title");o&&o.remove();const n=t[0].list_name;document.querySelectorAll(".category-card-title").forEach(s=>{s.remove()}),a.categoryCardElem.insertAdjacentHTML("afterbegin",E(n)),k(C,a.categoryCardElem,t)}catch(t){console.error("Error fetching category books:",t)}};function E(e){return`
