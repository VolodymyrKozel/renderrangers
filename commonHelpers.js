import{r as a,a as g}from"./assets/renderMarkup-15bca558.js";import{a as y}from"./assets/vendor-0cb09735.js";const k="https://books-backend.p.goit.global/books/";async function i(t,e){try{return(await y.get(k+t,{params:e})).data}catch(o){console.error(o)}}console.log("category-card");const f=async t=>{a.categoryCardElem.innerHTML="",a.topSellerSection.innerHTML="";try{const e=await i("category",t),o=a.categoryCardElem.querySelector(".category-card-title");o&&o.remove();const r=e[0].list_name;document.querySelectorAll(".category-card-title").forEach(s=>{s.remove()}),a.categoryCardElem.insertAdjacentHTML("beforebegin",b(r)),g(w,a.categoryCardElem,e)}catch(e){console.error("Error fetching category books:",e)}};function b(t){return`
