import{i as M,r as p,a as q,b as B,c as x,d as I,e as i}from"./assets/header-2bc75c4b.js";import{a as N}from"./assets/vendor-94a85c0e.js";const A="https://books-backend.p.goit.global/books/";async function m(e,t){try{return(await N.get(A+e,{params:t})).data}catch(o){console.error(o)}}function H(e){e.forEach(t=>{t.classList.add("animation-items")}),setTimeout(()=>{e.forEach(t=>{t.classList.remove("animation-items")})},500)}function O({_id:e,book_image:t,title:o,author:n,description:s,buy_links:a}){return`
