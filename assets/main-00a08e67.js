import{a as d}from"./vendor-0cb09735.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function o(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=o(r);fetch(r.href,n)}})();const i={categoryListElem:document.querySelector(".js-category-list"),categoryCardElem:document.querySelector(".js-category-card"),categoryCardSection:document.querySelector(".js-category"),supportList:document.querySelector(".js-support-list"),scrollBtn:document.querySelector(".js-support-btn"),scrollToTopBtn:document.querySelector(".js-scrollToTopBtn")},f="https://books-backend.p.goit.global/books/";async function l(t,e){try{return(await d.get(f+t,{params:e})).data}catch(o){console.error(o)}}function h(t,e){return e.map(t).join("")}function c(t,e,o){const s=h(t,o);if(e===null)return s;e.innerHTML="",e.insertAdjacentHTML("beforeend",s)}console.log("category-card");const y=async t=>{const e=await l("category",t);console.log(e),i.categoryCardElem.insertAdjacentHTML("beforebegin",b(e[0].list_name)),c(k,i.categoryCardElem,e)};function b(t){return`
    ...
    `,e.appendChild(r)}),e}function T(t){let e="";const o=C(),s=o==="desktop"?5:o==="tablet"?3:1;for(let r=0;r<s&&r<t.length;r++){const{book_image:n,title:a,author:m,_id:g}=t[r];e+=`
...
//# sourceMappingURL=main-00a08e67.js.map
