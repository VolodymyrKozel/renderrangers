import{c as d,d as f,e as r,r as n,b as h}from"./assets/header-dd4c875e.js";import{P as u}from"./assets/vendor-94a85c0e.js";const k=document.querySelector("#tui-pagination-container");let l=2,c=4;window.innerWidth>=768&&(l=3,c=3);const y={itemsPerPage:c,visiblePages:l},$=new u(k,y);$.movePageTo(1);const p={isSupported(){return typeof Storage<"u"},has(e){return localStorage.hasOwnProperty(e)},get(e){let t=localStorage.getItem(e);if(typeof t!="string")return t;if(t!=="undefined")return t==="null"?null:/^'-?\d{1,}?\.?\d{1,}'$/.test(t)||/^'-?\d{1}\.\d+e\+\d{2}'$/.test(t)?Number(t):t[0]==="{"||t[0]==="["?JSON.parse(t):t},set(e,t){if(typeof e!="string")throw new TypeError(`localStorage: Ключ повинен бути рядком. (зчитування '${e}')`);(typeof t=="object"||Array.isArray(t))&&(t=JSON.stringify(t)),localStorage.setItem(e,t)},remove(e){localStorage.removeItem(e)}};function b({_id:e,list_name:t,author:o,title:s,book_image:i,description:g,buy_links:m}){return`<li class="shopping-item" data-id="${e}">
            <img
              class="shopping-img"
              src="${i}"
              alt="${s}"
