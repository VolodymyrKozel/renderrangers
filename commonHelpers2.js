import{i as b,b as k,d as S,a as $,c as v,r as L,e as i}from"./assets/header-d9a75999.js";import{P}from"./assets/vendor-94a85c0e.js";function N({_id:e,list_name:t,author:a,title:s,book_image:o,description:n,buy_links:r}){return`<li class="shopping-item" data-id="${e}">
            <img
              class="shopping-img"
              src="${o}"
              alt="${s}"
